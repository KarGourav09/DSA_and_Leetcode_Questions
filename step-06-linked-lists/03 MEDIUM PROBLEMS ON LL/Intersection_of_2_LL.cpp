...
Solution: iterate through both the LL, and match their pointer references, if they match return the node, else return null.
*/
...
int main() {
    // Example usage: listA = [4,1,8,4,5] and listB = [5,6,1,8,4,5] with intersection at node with value 8
